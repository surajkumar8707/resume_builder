...
>
  <head>
    ...
    <!-- Core CSS -->
    <link rel="stylesheet" href="{{ public_asset('assets/admin/vendor/css/core.css') }}" class="template-customizer-core-css" />
    <link rel="stylesheet" href="{{ public_asset('assets/admin/vendor/css/theme-default.css') }}" class="template-customizer-theme-css" />
    <link rel="stylesheet" href="{{ public_asset('assets/admin/css/demo.css') }}" />

    <!-- Vendors CSS -->
    <link rel="stylesheet" href="{{ public_asset('assets/admin/vendor/libs/perfect-scrollbar/perfect-scrollbar.css') }}" />
  ...
  <body>
    ...
    <div class="container-xxl container-p-y">
      <div class="misc-wrapper">
        ...
        <div class="mt-3">
          <img
            src="{{ public_asset('assets/admin/img/illustrations/page-misc-error-light.png') }}"
