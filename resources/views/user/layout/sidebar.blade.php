<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3"
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="{{ route('user.dashboard') }}">
            <img src="{{ public_asset('assets/user/img/logo-ct-dark.png') }}" class="navbar-brand-img h-100"
                alt="main_logo" />
            <span class="ms-1 font-weight-bold">Resume Builder</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link @isActiveRoute('user.dashboard')" href="{{ route('user.dashboard') }}">
                    <div
            ...
            <li class="nav-item">
                <a class="nav-link @isActiveRoute(['user.my.resumes.index', 'user.my.resumes.create', 'user.my.resumes.edit', 'user.my.resumes.show'])" href="{{ route('user.my.resumes.index') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" width="655.359" height="655.359"
                    ...
                    <span class="nav-link-text ms-1">My Resume</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link @isActiveRoute('user.profile')" href="{{ route('user.profile') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link @isActiveRoute('user.password')" href="{{ route('user.password') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 46 42" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
